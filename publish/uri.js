 ...
 */
export const trimSlashes = (input) => {
    ...
    if (stripLast || stripFirst) {
        ...
        return input.slice(stripFirst ^ 0, input.length - stripLast ^ 0);
    }
    else {
        return input;
    }
 ...
 */
export const encodeURLQueryString = (params) => Object.keys(params)
